...
function getGenres(stringToFindBy) {
    ...
    $.get(
        "filter.aspx",
        {stringToFilterBy:stringToFindBy}
        ,
        function (data) {
            $("#tablediv").html(data);
        }
  ...
  .fail(function () {
    ...
    xmlhttp.open("GET", "filter.aspx?q=" + stringToFindBy, true);
    xmlhttp.send();
    */
}
...
function deleteBook(id,row) {
    ...
    var table = document.getElementById("mainTableBooks");
    var row = document.getElementById(row);
    console.log(row.rowIndex);
    $.get("requestHandler.aspx", { action:"delete",bookID: id }, function (data, status) { console.log(status); });
